...
async function run() {
  try {
    ...
    const userCollection = client.db("msrRestaurantDb").collection("users");
    const menuCollection = client.db("msrRestaurantDb").collection("menu");
    const reviewCollection = client.db("msrRestaurantDb").collection("reviews");
    const cartCollection = client.db("msrRestaurantDb").collection("carts");
    const paymentCollection = client.db("msrRestaurantDb").collection("payments");
